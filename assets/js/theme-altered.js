            ...
            (M = (function () {
                ...
                return (
                    ...
                    (t.addEventListeners = function () {
                        ...
                        p(this.element).on(k.MOUSE_ENTER, function (t) {
                            t.stopPropagation(), (t.type + v === k.MOUSE_ENTER && e.isActive) || e.toggle();
                        }),
                        p(this.element).on(k.MOUSE_LEAVE, function (t) {
                        	t.stopPropagation(), (t.type + v === k.MOUSE_LEAVE && e.isActive) || e.toggle();
                        }),
                    ...
                    */
                    ...
                    (t.addEventListeners = function () {
                        ...
                        p(this.element).on(k.MOUSE_ENTER, function (t) {
                            ...
                            this.hover &&
                                p(this.parent).on(k.MOUSE_ENTER + " " + k.MOUSE_LEAVE, function (t) {
                                    t.preventDefault(), t.stopPropagation(), e.toggle(), (t.type + v === k.MOUSE_ENTER && e.isActive) || (t.type + v === k.MOUSE_LEAVE && !e.isActive) || e.toggle(t);
                                });
                    }),
